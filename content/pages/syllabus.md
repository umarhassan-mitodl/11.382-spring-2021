...
Entering into our third semester impacted by the ongoing pandemic, MIT recognizes the difficult and unusual circumstances continuing to impact everyone in our community. To ensure the highest quality educational experience during these times, MIT’s Academic Policy and Regulations Team (APART) has developed {{% resource_link "f53958c9-384f-4cfc-b0b7-e79417feb1a3" "recommendations and regulations" %}} for the Spring 2021 term. This syllabus has been developed, and this class will be conducted, in full adherence to the APART policies and the {{% resource_link "32171770-a2e6-4031-aabe-6732e1f962bc" "grading policy" %}} for Spring 2021. Other term regulations and examination policies remain in effect.
